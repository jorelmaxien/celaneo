...
public class PartyHelper {
    ...
    public static String getPartyName1(Delegator delegator, String partyId, boolean lastNameFirst) {
        GenericValue partyObject = null;
        try {
            partyObject = EntityQuery.use(delegator).from("PartyNameView").where("partyId", partyId).queryOne();
        } catch (GenericEntityException e) {
        ...
        return partyObject.getString("firstName")+" "+partyObject.getString("lastName") ;
    }
    ...
    public static String getPartyName1(GenericValue partyObject, boolean lastNameFirst) {
        if (partyObject == null) {
            return "";
        }
        if ("PartyGroup".equals(partyObject.getEntityName()) || "Person".equals(partyObject.getEntityName())) {
        ...
        return getPartyName1(partyObject.getDelegator(), partyId, lastNameFirst);
    }
