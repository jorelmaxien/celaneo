...
<div id="findEmployee" class="screenlet">
    <div class="screenlet-title-bar">
        <ul>
            <li class="h3">${uiLabelMap.CommonFind} ${uiLabelMap.HumanResEmployees}</li>
        ...
        <div class="screenlet-body">
            ...
            <form method="post" name="lookupparty" action="<@ofbizUrl>findEmployees</@ofbizUrl>" class="basic-form">
                ...
                <table cellspacing="0">
                    ...
                    <tr align="center">
                        <td>&nbsp;</td>
                        <td><input type="submit" value="${uiLabelMap.PartyLookupEmployee}"/>
...
<#if partyList??>
    ...
    <div id="findEmployeeResults" class="screenlet">
        <div class="screenlet-title-bar">
            <ul>
                <li class="h3">${uiLabelMap.PartyEmployeesFound}</li>
                <#if (partyListSize > 0)>
...
<#--                        <td><a href="<@ofbizUrl>EmployeeProfile?partyId=${partyRow.partyId}</@ofbizUrl>">${partyRow.partyId}</a></td>-->
                        <td>
                            <#if partyRow.registrationNumber?has_content>
                                <a href="<@ofbizUrl>EmployeeProfile?partyId=${partyRow.partyId}</@ofbizUrl>">${partyRow.registrationNumber}</a>
                            <#else>
                               (PAS DE MATRICULE)
                            </#if>
                        </td>
...
<#--                        <td><#if partyType.description??>${partyType.get("description", locale)}<#else>???</#if></td>-->
        ...
        <#else>
            <div class="screenlet-body">
                <span class="h3">${uiLabelMap.PartyNoEmployeesFound}</span>
            </div>
        </#if>
