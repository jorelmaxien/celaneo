...
context.currentPeriodTimeId = parameters.customTimePeriodId;
context.customPeriod = delegator.findOne("CustomTimePeriod",true, UtilMisc.toMap("customTimePeriodId", context.currentPeriodTimeId));
logger.info ("I am a test info log" + context.currentPeriodTimeId);
