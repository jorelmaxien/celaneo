...
<#--<#if security.hasPermission("PERIOD_MAINT", session)>-->
    <div class="card col-sm-8 offset-sm-2">
        <div class="card-header h3 green darken-4 white-text text-darken-4 w-100 font-weight-bolder" >
           ${uiLabelMap.AccountingGlAccountImportDataTitle}
        </div>
        <div class="card-body">
        <form method="post" class="row" action="<@ofbizUrl>importChartOfAccount</@ofbizUrl>" name="importGlAccountDataForm" enctype="multipart/form-data">
...
<#--            <input type="file" name="orgchartofAccount" value="${findOrganizationPartyId!}" />-->
            ...
            <div class="md-form col-sm-12">
                ...
                <div class="file-path-wrapper text-wrap" style="border-bottom: 1px solid grey;">
                    <input class="file-path validate text-wrap" type="text" placeholder='${uiLabelMap.CommonSelectFileDataLabel}' style="width: 18rem;">
                </div>
                </div>
            </div>
