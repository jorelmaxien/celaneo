        ...
        <div class="card-body">
            ...
            <#if authentificationPayement?has_content>
                <div class="form-header rpn-green-gradient">
                    <h3 class="white-text">payement numero: ${authentificationPayement.authentificationPayementId}</h3>
                </div>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>${authentificationPayement.getRelatedOne("PurchaseOrder").getRelatedOne("Person").get("firstName", locale)} ${authentificationPayement.getRelatedOne("PurchaseOrder").getRelatedOne("Person").get("lastName", locale)}</td>
                    </tr>
                    <tr>
                        <th scope="row">${uiLabelMap.customerPhone}:</th>
                        <td>${authentificationPayement.getRelatedOne("PurchaseOrder").phone}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>${authentificationPayement.getRelatedOne("PurchaseOrder").paymentPlace}</td>
                    </tr>
                    <tr>
                        <th scope="row">${uiLabelMap.customerPurchasePaymentMode}</th>
                        <td>${authentificationPayement.getRelatedOne("PurchaseOrder").getRelatedOne("PurchasePaymentMode").get("description", locale)}</td>
                    </tr>
                    <tr>
            ...
            <#if authentificationPayement?has_content>
                <#list partyRoles as partyRole>
                    <#if partyRole.roleTypeId == 'Direction financière'>
                        <#if authentificationPayement.purchaseOrderStatusId == '3'>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<@ofbizUrl>rejetPayement</@ofbizUrl>" id="rejet" method="post">
                    <input type="hidden" value="${authentificationPayement.authentificationPayementId}" name="authentificationPayementId">
...
<div class="modal fade" id="basicExampleModalValidation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<@ofbizUrl>validationPayement</@ofbizUrl>">
                    <input type="hidden" value="${authentificationPayement.authentificationPayementId}" name="authentificationPayementId">
                    <div>
