                ...
                <form name="app_registration" method="post" action="<@ofbizUrl>createCommande</@ofbizUrl>">
                            ...
                            <div class="step-new-content" style="left: 0%; display: block;">
                                    ...
                                    <div class="col-md-4 md-form">
                                        <span class="field-lookup">
                                            ...
                                            <input type="text"
                                                   ...
                                                   data-lookup-ajax-url="PurchaseFroms_partyIdTo,https://localhost:8443/ar/control/LookupPartyName,ajaxLookup=Y&amp;searchValueFieldName=partyId" autocomplete="off"
                                            >
                                        </span>
                                    </div>
                                ...
                                <div class="step-actions d-md-flex align-items-md-end">
                                    <button class="waves-effect waves-dark float-right btn btn-rounded rpn-green-gradient btn-sm btn-primary" type="submit">Enregistrer</button>
                                </div>
                            </div>
