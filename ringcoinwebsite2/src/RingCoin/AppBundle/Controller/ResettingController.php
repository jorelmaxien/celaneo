...
class ResettingController extends Controller
{
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        if ($user==null){
            $request->getSession()
                ->getFlashBag()
                ->add('toast_danger', 'Aucun compte ne correspond a l\'adresse e-mail ou au nom d\'utilisateur mentionne');
            $this->redirectToRoute('fos_user_resetting_request');
        ...
        if (null !== $user && !$user->isPasswordRequestNonExpired($ttl)) {
            ...
            $this->get('fos_user.mailer')->sendResettingEmailMessage($user, $parameters);
